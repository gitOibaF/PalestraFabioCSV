...
public class AggiungiIscritto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Inserire i dati per completare l'iscrizione:");
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
       //cognome = jTextField2.getText().trim();
    ...
    if (!nome.isEmpty() && !cognome.isEmpty() && !codice.isEmpty()) {
        ...
        jLabel6.setVisible(false);
        a = PA.addI(nome, cognome,codice);
        if(a){
           jLabel13.setText("Iscrizione completata");
           jLabel13.setVisible(true);
        }
        else{
            jLabel13.setText("Iscrizione fallita o Persona già Iscritta");
            jLabel13.setVisible(true);
        }
    } else {
